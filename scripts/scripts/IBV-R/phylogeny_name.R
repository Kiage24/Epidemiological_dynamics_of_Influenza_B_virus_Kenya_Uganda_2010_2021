...
NS_df1 <- subset(NS_df1, sample_id %in% complete$sample_id)

#Unite the columns into the header

NS_df1 <- unite(NS_df1, phylogeny_name, c(sample_id,facility_name,Collection_date), sep = '|')
...
writeFasta(NS_df1, '~/Desktop/Msc/flub_results/renamed/NS_renamed.fa')

...
NA_tree <- read.tree("~/Desktop/Msc/flub_results/genotyping/iqtree/NA_tree.nwk")
NA_tree$tip.label


#Create a metadata file with the year and location column
metadata <- NA_tree$tip.label
...
#Write to file
write_tsv(dates, "~/Desktop/Msc/flub_results/genotyping/treetime/NA_vicdates1.tsv")
